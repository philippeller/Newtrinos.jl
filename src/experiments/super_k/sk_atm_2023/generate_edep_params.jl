#!/usr/bin/env julia
# Stage 2 only: fit E-dependent β per bin, using existing energy + vMF params
# Reads energy_response_params.jld2 and vmf_cosz_params.jld2
# Overwrites vmf_cosz_params.jld2 with added beta and E_ref fields
